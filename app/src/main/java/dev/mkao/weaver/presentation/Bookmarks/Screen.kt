...
sealed class Screen(val route: String, val title: String, val icon: ImageVector) {
    ...
    object Categories : Screen("categories_screen", "Bulletin", Icons.Filled.CheckCircle)
    ...
    object NewsArticle : Screen("news_article", "News Article", Icons.Default.Home) // Add appropriate icon if needed
}
